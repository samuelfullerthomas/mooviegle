...
const App = () => {
  ...
  return <div>
    <div className='thing'>
      <img className='logo' src='https://user-images.githubusercontent.com/10165959/155548924-be99c42a-30c3-4300-a09b-58787e8a1b0c.png' />
    </div>
    <AtomicSearchInterface engine={engine}>
      <div className='search'>
        <AtomicSearchBox className='box'>
          <AtomicSearchBoxQuerySuggestions />
        </AtomicSearchBox>
      </div>
      <AtomicFacet field='languages'  label='Date Released' withSearch={false} /> 
      <br />
      <AtomicResultList template={ResultTemplate} fieldsToInclude="description,id,title,link,year,datepublished,genres,duration,countries,languages,directors,budget,score,image" />
    </AtomicSearchInterface>
